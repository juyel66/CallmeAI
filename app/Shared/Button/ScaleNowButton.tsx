...
type ScaleNowButtonProps = {
    className?: string;
};

const ScaleNowButton = ({ className = "" }: ScaleNowButtonProps) => {
    ...
    return (
        <button
            ...
            className={`relative w-full cursor-pointer overflow-hidden rounded-xl border-2 border-[#8E00FF] bg-white px-6 py-3 text-base font-semibold text-[#6F14F1] sm:w-auto sm:px-8 sm:py-4 sm:text-lg ${className}`}
        >
