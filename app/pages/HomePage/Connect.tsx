...
import imageBanner from '../../../public/images/Rectangle 8 copy.svg';
import iconsImage from '../../../public/images/framm.svg';

const Connect = () => {
  return (
    <section className="w-full bg-linear-to-b from-white via-[#f6f4fb] to-[#f3f0f9] py-14 sm:py-20 md:py-24 lg:py-28 transition-all duration-300">
